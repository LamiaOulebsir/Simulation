...
## MCAR
var_mcar_moy <- var(var_moy_X1_mcar)
var_mcar_med <- var(var_med_X1_mcar)
var_mcar_complet <- var(var_complet_X1_mcar)

## MAR
var_mar_complet <- var(var_complet_X1_mar) 
var_mar_moy <- var(var_moy_X1_mar) 
var_mar_med <- var(var_med_X1_mar)

## MNAR
var_mnar_complet <- var(var_complet_X1_mnar)
var_mnar_moy <- var(var_moy_X1_mnar)
var_mnar_med <- var(var_med_X1_mnar)
...
## MCAR
med_mcar_complet <- median(med_complet_X1_mcar)
med_mcar_moy <- median(med_moy_X1_mcar)
med_mcar_med <- median(med_med_X1_mcar)

## MAR
med_mar_complet <- median(med_complet_X1_mar)
med_mar_moy <- median(med_moy_X1_mar)
med_mar_med <- median(med_med_X1_mar )

## MNAR
med_mnar_complet <- median(med_complet_X1_mnar) 
med_mnar_moy <- median(med_moy_X1_mnar)
med_mnar_med <- median(med_med_X1_mnar)
